...
// Permet en LOCAL de lier une Key SFML à une action d'entité
struct ActionKeyBind : public Component { // Ce composant est pour le moment géré et reste en local (dans le futur il devrait être aussi envoyé aux clients)

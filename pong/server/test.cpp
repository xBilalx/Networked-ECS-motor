...
int main() {
    ...
    SceneManager.addScene("PongScene", [](Scene& scene) {
        ...
        PaddleModel paddleLeft(scene, 50, windowSize.y / 2.0f, 1, paddleWidth, paddleHeight);
        PaddleModel paddleRight(scene, windowSize.x - 50, windowSize.y / 2.0f, 2, paddleWidth, paddleHeight);
